					...
					<div class="box1">
						<div class="line1"><div class="line2 wrapper">
							...
							<section class="col1 pad_left1">
								...
								This website template has several pages:<a href="index.php" class="link1">Home</a>,<a href="Mission.html" class="link1">Our Mission</a>,<a href="News.html" class="link1">News and Press</a>,<a href="Help.php" class="link1">How to Help</a>,<a href="Contact.php" class="link1">Contact Us</a>.<a href="#" class="button1 color3">Read More</a>
							</section>
						</div></div>
					</div>	
				</div>
